...
echo "========================================="
echo "Building WASM Minimal (Size-Optimized)"
echo "========================================="
...
echo "Build Complete!"
echo "========================================="
ls -lh cpptoc-minimal.wasm
echo ""
echo "Compressed sizes:"
gzip -c cpptoc-minimal.wasm | wc -c | awk '{printf "Gzip: %.2f MB\n", $1/1024/1024}'
brotli -c cpptoc-minimal.wasm | wc -c | awk '{printf "Brotli: %.2f MB\n", $1/1024/1024}' || echo "Brotli not available"
echo "========================================="

 ...
 */
TEST_F(RangeForContainerTest, SimpleContainerWithPointerIterator) {
 ...
 */
TEST_F(RangeForContainerTest, CustomIteratorStruct) {
    std::string cppCode = R"(
 ...
 */
TEST_F(RangeForContainerTest, NestedContainerLoops) {
    std::string cppCode = R"(
        struct IntArray {
            int data[3];
            int size;
 ...
 */
TEST_F(RangeForContainerTest, ContainerAndArray) {
    std::string cppCode = R"(
        struct IntContainer {
            int data[3];
            int size;
 ...
 */
TEST_F(RangeForContainerTest, ConstContainerDetection) {
    std::string cppCode = R"(
        struct IntContainer {
            int data[3];
            int size;

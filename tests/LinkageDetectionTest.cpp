...
TEST_F(LinkageDetectionTest, MixedLinkage: C and C++ functions in same file) {
    const char *code = R"(
...
TEST_F(LinkageDetectionTest, ExternCStaticFunction: static function with C linkage) {
    const char *code = R"(
            extern "C" {
                static void helper() {
...
TEST_F(LinkageDetectionTest, CppFunctionDefaultLinkage: regular C++ function) {
    const char *code = R"(
            void normalFunc() {
                // Regular C++ function
            }

...
int main() {
	struct Vector3D v1 = (Vector3D){1.F, 2.F, 3.F};
	struct Vector3D v2 = (Vector3D){4.F, 5.F, 6.F};
	...
	struct Matrix3x3 m1 = (Matrix3x3){1, 0, 0, 0, 1, 0, 0, 0, 1};
	struct Matrix3x3 m2 = (Matrix3x3){2, 0, 0, 0, 2, 0, 0, 0, 2};

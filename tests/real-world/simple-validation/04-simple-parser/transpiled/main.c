...
int main() {
	...
	ExpressionEvaluator__ctor_0(&eval);
	printf("Expression Evaluator Tests:\n");
	const char * expr1 = "2 + 3";
	int result1 = ExpressionEvaluator_evaluate_const_int_ptr(&eval, expr1);
	printf("  %s = %d\n", expr1, result1);
	const char * expr2 = "10 - 4";
	int result2 = ExpressionEvaluator_evaluate_const_int_ptr(&eval, expr2);
	printf("  %s = %d\n", expr2, result2);
	const char * expr3 = "2 * 3 + 4";
	int result3 = ExpressionEvaluator_evaluate_const_int_ptr(&eval, expr3);
	printf("  %s = %d\n", expr3, result3);
	const char * expr4 = "20 / 4";
	int result4 = ExpressionEvaluator_evaluate_const_int_ptr(&eval, expr4);
	printf("  %s = %d\n", expr4, result4);
	const char * expr5 = "2 + 3 * 4";
	int result5 = ExpressionEvaluator_evaluate_const_int_ptr(&eval, expr5);
	printf("  %s = %d\n", expr5, result5);
	bool passed = true;

// Generated from: /Users/alexanderfedin/Projects/hapyy/hupyy-cpp-to-c/./tests/ReferenceTranslationTest.cpp
// Implementation file

#include "ReferenceTranslationTest.h"
...
int transpileToCCode(const int * cppCode) {
	int &Context;

	struct CNodeBuilder builder;

	struct FileOriginTracker tracker;
...
static void ReferenceTranslationTest__ctor_default(struct ReferenceTranslationTest * this) {
}

static void ReferenceTranslationTest__ctor_copy(struct ReferenceTranslationTest * this, const struct ReferenceTranslationTest * other) {
}

int TEST_F(struct ReferenceTranslationTest, int) {
...
int TEST_F_ReferenceTranslationTest_int(struct ReferenceTranslationTest, int) {
	const char *cpp = "\n        struct Point {\n            int x, y;\n        };\n\n        void modify(Point& p) {\n            p.x = 10;\n            p.y = 20;\n        }\n    ";
...
int TEST_F_ReferenceTranslationTest_int_1(struct ReferenceTranslationTest, int) {
...
int TEST_F_ReferenceTranslationTest_int_2(struct ReferenceTranslationTest, int) {
	const char *cpp = "\n        struct Container {\n            int data;\n            int& get() { return data; }\n        };\n    ";
...
int TEST_F_ReferenceTranslationTest_int_3(struct ReferenceTranslationTest, int) {
...
int TEST_F_ReferenceTranslationTest_int_4(struct ReferenceTranslationTest, int) {
...
int TEST_F_ReferenceTranslationTest_int_5(struct ReferenceTranslationTest, int) {

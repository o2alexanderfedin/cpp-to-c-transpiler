// Generated from: /Users/alexanderfedin/Projects/hapyy/hupyy-cpp-to-c/./tests/unit/move_semantics/CopyMoveIntegrationTest.cpp
// Implementation file

#include "CopyMoveIntegrationTest.h"
...
static void CopyMoveCollector__ctor_default(struct CopyMoveCollector * this) {
	this->copyConstructors = 0;
	this->moveConstructors = 0;
	this->copyAssignments = 0;
	this->moveAssignments = 0;
}

static void CopyMoveCollector__ctor_copy(struct CopyMoveCollector * this, const struct CopyMoveCollector * other) {
	this->copyConstructors = other->copyConstructors;
	this->moveConstructors = other->moveConstructors;
	this->copyAssignments = other->copyAssignments;
	this->moveAssignments = other->moveAssignments;
}

bool CopyMoveCollector_VisitCXXConstructorDecl(struct CopyMoveCollector * this, int * D) {
	return true;
;
}

bool CopyMoveCollector_VisitCXXMethodDecl(struct CopyMoveCollector * this, int * D) {
	return true;
;
}

static void CallExprFinder__ctor_default(struct CallExprFinder * this) {
	this->callExprs = 0;
	this->constructExprs = 0;
}

static void CallExprFinder__ctor_copy(struct CallExprFinder * this, const struct CallExprFinder * other) {
	this->callExprs = other->callExprs;
	this->constructExprs = other->constructExprs;
}

bool CallExprFinder_VisitCallExpr(struct CallExprFinder * this, int * E) {
	return true;
;
}

bool CallExprFinder_VisitCXXConstructExpr(struct CallExprFinder * this, int * E) {
	return true;
;
}

static void CopyMoveIntegrationTest__ctor_default(struct CopyMoveIntegrationTest * this) {
}

static void CopyMoveIntegrationTest__ctor_copy(struct CopyMoveIntegrationTest * this, const struct CopyMoveIntegrationTest * other) {
}

int TEST_F(struct CopyMoveIntegrationTest, int site) {
...
int TEST_F_CopyMoveIntegrationTest_int(struct CopyMoveIntegrationTest, int naming) {
	...
	struct CopyMoveCollector Collector;
...
int TEST_F_CopyMoveIntegrationTest_int_1(struct CopyMoveIntegrationTest, int safety) {
	...
	struct MoveConstructorTranslator MoveTranslator;
...
int TEST_F_CopyMoveIntegrationTest_int_2(struct CopyMoveIntegrationTest, int safety) {

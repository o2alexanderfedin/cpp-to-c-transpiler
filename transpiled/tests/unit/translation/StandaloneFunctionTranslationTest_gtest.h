// Generated from: /Users/alexanderfedin/Projects/hapyy/hupyy-cpp-to-c/./tests/unit/translation/StandaloneFunctionTranslationTest_gtest.cpp
// Header file
...
struct StandaloneFunctionTranslationTestFixture {
};
static void StandaloneFunctionTranslationTestFixture__ctor_default(struct StandaloneFunctionTranslationTestFixture * this);
static void StandaloneFunctionTranslationTestFixture__ctor_copy(struct StandaloneFunctionTranslationTestFixture * this, const struct StandaloneFunctionTranslationTestFixture * other);
int StandaloneFunctionTranslationTestFixture_buildAST(struct StandaloneFunctionTranslationTestFixture * this, const int * code);
int TEST_F(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int_1(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int_2(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int_3(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int_4(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int_5(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int_6(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int_7(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int_8(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int_9(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int_10(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int_11(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int_12(struct StandaloneFunctionTranslationTestFixture, int);
int TEST_F_StandaloneFunctionTranslationTestFixture_int_13(struct StandaloneFunctionTranslationTestFixture, int);

// Generated from: /Users/alexanderfedin/Projects/hapyy/hupyy-cpp-to-c/./tests/LinkageDetectionTest.cpp
// Implementation file

#include "LinkageDetectionTest.h"
...
static void LinkageDetectionTest__ctor_default(struct LinkageDetectionTest * this) {
}

static void LinkageDetectionTest__ctor_copy(struct LinkageDetectionTest * this, const struct LinkageDetectionTest * other) {
}

int TEST_F(struct LinkageDetectionTest, int) {
...
int TEST_F_LinkageDetectionTest_int(struct LinkageDetectionTest, int) {
	const char *code = "\n            extern \"C\" {\n                void init();\n                void cleanup();\n                int process(int x);\n            }\n        ";
...
int TEST_F_LinkageDetectionTest_int_1(struct LinkageDetectionTest, int) {
...
int TEST_F_LinkageDetectionTest_int_2(struct LinkageDetectionTest, int) {
	const char *code = "\n            namespace MyNS {\n                extern \"C\" void foo();\n            }\n        ";
...
int TEST_F_LinkageDetectionTest_int_3(struct LinkageDetectionTest, int) {
...
int TEST_F_LinkageDetectionTest_int_4(struct LinkageDetectionTest, int) {
	const char *code = "\n            void normalFunc() {\n                // Regular C++ function\n            }\n        ";

...
static void ValidationTest__ctor_default(struct ValidationTest * this) {
}

static void ValidationTest__ctor_copy(struct ValidationTest * this, const struct ValidationTest * other) {
}

int ValidationTest_createTestAST(struct ValidationTest * this, const int * code, const int * filename) {
}

bool ValidationTest_compileC(struct ValidationTest * this, const int * cFile, int * errors) {
	int cmd;
...
int ValidationTest_compileAndRunC(struct ValidationTest * this, const int * cFile) {
	int cmd;
...
bool ValidationTest_isValgrindAvailable(struct ValidationTest * this) {
}

bool ValidationTest_checkMemorySafety(struct ValidationTest * this, const int * cFile, bool * skipped) {
	skipped = false;
	if (!this->isValgrindAvailable()) 	{
		skipped = true;
		return true;
;
	}
...
int TEST_F(struct ValidationTest, int) {
	auto AST;
...
int TEST_F_ValidationTest_int(struct ValidationTest, int) {
	auto AST;
...
int TEST_F_ValidationTest_int_1(struct ValidationTest, int) {
	auto AST;
...
int TEST_F_ValidationTest_int_2(struct ValidationTest, int) {
	auto AST;
...
int TEST_F_ValidationTest_int_3(struct ValidationTest, int) {
	auto AST;
...
int TEST_F_ValidationTest_int_4(struct ValidationTest, int) {
	int output;

}

int TEST_F_ValidationTest_int_5(struct ValidationTest, int) {
	int output;

}

int TEST_F_ValidationTest_int_6(struct ValidationTest, int) {
	int output;

}

int TEST_F_ValidationTest_int_7(struct ValidationTest, int) {
	int output;

}

int TEST_F_ValidationTest_int_8(struct ValidationTest, int) {
	int output;

}

int TEST_F_ValidationTest_int_9(struct ValidationTest, int) {
	bool skipped;
...
int TEST_F_ValidationTest_int_10(struct ValidationTest, int) {
	bool skipped;
...
int TEST_F_ValidationTest_int_11(struct ValidationTest, int) {
	bool skipped;
...
int TEST_F_ValidationTest_int_12(struct ValidationTest, int) {
	bool skipped;
...
int TEST_F_ValidationTest_int_13(struct ValidationTest, int) {
	bool skipped;
